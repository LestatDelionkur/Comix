    ...
    public partial class FirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComicsKind", x => x.Id);
                });
            migrationBuilder.CreateTable(
                name: "Person",
                columns: table => new
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<long>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    ComicKindId = table.Column<long>(nullable: false),
                    ComicsKindId = table.Column<long>(nullable: true),
                    ComicsType = table.Column<int>(nullable: false),
                    Description = table.Column<string>(nullable: true),
                    Edited = table.Column<DateTime>(nullable: false),
                    ParentComicsId = table.Column<long>(nullable: true),
                    Title = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comics_ComicsKind_ComicsKindId",
                        column: x => x.ComicsKindId,
                        principalTable: "ComicsKind",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Comics_Comics_ParentComicsId",
                        column: x => x.ParentComicsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ComicsPerson", x => new { x.ComicsId, x.PersonId });
                    table.ForeignKey(
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable("ComicsPerson");
            migrationBuilder.DropTable("Comics");
            migrationBuilder.DropTable("Person");
            migrationBuilder.DropTable("PersonType");
            migrationBuilder.DropTable("ComicsKind");
            migrationBuilder.AlterColumn<string>(
                name: "UserId",
                table: "AspNetUserLogins",
                nullable: true);
